...
ThemeData buildSupportTheme() {
  ...
  return b.copyWith(
    ...
    colorScheme: b.colorScheme.copyWith(
        primary: SupportColors.accent, surface: SupportColors.surface),
    textTheme: b.textTheme.apply(
        bodyColor: SupportColors.textPrimary,
        displayColor: SupportColors.textPrimary),
    ...
    dividerColor: SupportColors.border,
  );
}
