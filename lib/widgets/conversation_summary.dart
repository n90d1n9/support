        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            const Icon(Icons.auto_awesome_rounded,
                size: 15, color: SupportColors.accent),
            ...
            TextButton.icon(
                ...
                icon: loading
                    ? const SizedBox(
                        ...
                        child: CircularProgressIndicator(
                            strokeWidth: 1.5, color: SupportColors.accent))
                    : Icon(
                        summary != null
                ...
                label: Text(
                    ...
                    style: const TextStyle(
                        fontSize: 12, color: SupportColors.accent)),
...
class _SS extends State<_Shimmer> with SingleTickerProviderStateMixin {
  ...
  Widget _b(double w) => FractionallySizedBox(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              color:
                  SupportColors.border.withValues(alpha: 0.3 + _c.value * 0.4),
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                if (editable) ...[
                  ...
                  const Icon(Icons.close_rounded,
                      size: 10, color: SupportColors.textSecondary)
                ]
              ])))),
    ...
    if (_e) {
      return SizedBox(
          ...
          child: TextField(
              ...
              autofocus: true,
              style: const TextStyle(
                  fontSize: 11, color: SupportColors.textPrimary),
    ...
    return InkWell(
        ...
        child: Container(
            ...
            child: const Row(mainAxisSize: MainAxisSize.min, children: [
              Icon(Icons.add, size: 11, color: SupportColors.textSecondary),
              SizedBox(width: 3),
              Text('tag',
                  style: TextStyle(
                      fontSize: 10.5, color: SupportColors.textSecondary))
            ])));
  }
}
