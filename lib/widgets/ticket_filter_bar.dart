  ...
  Widget build(BuildContext ctx, WidgetRef ref) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      TextField(
          ...
          style: const TextStyle(color: SupportColors.textPrimary),
          decoration: InputDecoration(
              hintText: 'Search tickets…',
              hintStyle: const TextStyle(color: SupportColors.textSecondary),
              prefixIcon:
                  const Icon(Icons.search, color: SupportColors.textSecondary),
              filled: true,
  ...
  Widget build(BuildContext ctx) {
    ...
    return Container(
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: sel ? SupportColors.accent : SupportColors.border)),
