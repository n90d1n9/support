  ...
  Widget build(BuildContext ctx, WidgetRef ref) {
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            border:
                Border.all(color: SupportColors.accent.withValues(alpha: 0.35)),
            gradient: LinearGradient(
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
                colors: [
                  SupportColors.accent.withValues(alpha: 0.08),
          ...
          if (aiState.state == AiCallState.loading) ...[
            ...
            Wrap(spacing: 6, runSpacing: 6, children: [
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                      color: SupportColors.priorityColor(
...
class _ShimmerState extends State<_Shimmer>
  ...
  Widget _b(double w) => FractionallySizedBox(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              color:
                  SupportColors.border.withValues(alpha: 0.3 + _a.value * 0.4),
