                  ...
                  child: notifs.isEmpty
                      ? const Center(
                          ...
                          Icon(Icons.notifications_off_rounded,
                              size: 40, color: SupportColors.border),
                          SizedBox(height: 8),
                          ...
                          itemBuilder: (ctx, i) {
                            ...
                            return Dismissible(
                                ...
                                child: ListTile(
                                    ...
                                    subtitle: Text(DateFormat('HH:mm').format(no.createdAt), style: const TextStyle(fontSize: 11, color: SupportColors.textSecondary)),
                                    tileColor: no.read ? null : SupportColors.accent.withValues(alpha: 0.04),
                                    onTap: () {
                                      n.markRead(no.id);
                                      if (no.ticketId != null) {
