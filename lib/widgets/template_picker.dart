...
import '../providers/ticket_providers.dart'; // Added for priorityColor extension
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle:
                            const TextStyle(color: SupportColors.textSecondary),
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide:
                              const BorderSide(color: SupportColors.border),
                        ),
                    ...
                    : tpls.isEmpty
                        ? const Center(
                            child: Text(
                              'No templates',
                              style:
                                  TextStyle(color: SupportColors.textSecondary),
                            ),
                          )
                        : ListView.builder(
                            controller:
                                sc as ScrollController, // Fixed: proper casting
                            padding: const EdgeInsets.all(16),
                            itemCount: tpls.length,
                            itemBuilder: (_, i) {
                              final t = tpls[i];
                              final c = SupportColors.priorityColor(t.priority);
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(12),
                                  border:
                                      Border.all(color: SupportColors.border),
                                ),
                                child: InkWell(
                                  borderRadius: BorderRadius.circular(12),
