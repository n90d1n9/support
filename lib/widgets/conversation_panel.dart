  ...
  Widget _buildBody(String text) {
    ...
    if (last < text.length) {
      spans.add(TextSpan(
          ...
          style: const TextStyle(
              color: SupportColors.textPrimary, fontSize: 13.5, height: 1.45)));
    }
      ...
      if (widget.isAgent)
        Container(
            ...
            child: TabBar(
                ...
                indicatorColor: SupportColors.accent,
                labelColor: SupportColors.accent,
                unselectedLabelColor: SupportColors.textSecondary,
                tabs: const [
                  Tab(
          ...
          child: messages.isEmpty
              ? const Center(
                  ...
                  Icon(Icons.chat_bubble_outline_rounded,
                      size: 36, color: SupportColors.border),
                  SizedBox(height: 8),
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
            if (widget.isAgent)
              IconButton(
                  ...
                  icon: const Icon(Icons.bolt_rounded,
                      size: 20, color: SupportColors.accent),
            ...
            Expanded(
                child: TextField(
                    ...
                    maxLines: 5,
                    style: const TextStyle(
                        color: SupportColors.textPrimary, fontSize: 14),
                    ...
                    decoration: InputDecoration(
                        ...
                        hintStyle: const TextStyle(
                            color: SupportColors.textSecondary, fontSize: 13),
                        filled: true,
