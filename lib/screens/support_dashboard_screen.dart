...
import '../widgets/team_workload_widget.dart';
          ...
          Padding(
              ...
              child: Column(children: [
                Icon(Icons.inbox_rounded,
                    size: 64,
                    color: SupportColors.border.withValues(alpha: 0.6)),
                const SizedBox(height: 12),
                const Text('No tickets match your filters',
                    style: TextStyle(
                        color: SupportColors.textSecondary, fontSize: 15))
              ]))
        else
    ...
    return SingleChildScrollView(
        ...
        child: Row(
            ...
            children: cols.map((s) {
              ...
              final color = SupportColors.statusColor(s);
              return Container(
                  width: 260,
