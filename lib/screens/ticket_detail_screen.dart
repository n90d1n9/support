...
import '../widgets/sla_progress_bar.dart';
import '../widgets/ticket_status_stepper.dart';
import '../widgets/conversation_panel.dart';
import '../widgets/assignment_panel.dart';
import '../widgets/refund_request_panel.dart';
import '../widgets/linked_entities_panel.dart';
import '../widgets/attachments_panel.dart';
import '../widgets/audit_trail_panel.dart';
import '../widgets/ai_assist_panel.dart';
import '../widgets/csat_panel.dart';
import '../widgets/merge_ticket_dialog.dart';
import '../widgets/customer_history_panel.dart';
import '../widgets/conversation_summary.dart';
import '../widgets/ticket_feature_widgets.dart';
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title:
              ...
              Text(ticket.subject,
                  ...
                  style: const TextStyle(
                      fontSize: 11.5, color: SupportColors.textSecondary))
            ]),
            actions: [
                      ...
                      .map((s) => PopupMenuItem(
                          ...
                          child: Row(children: [
                            Container(
                                ...
                                height: 8,
                                decoration: BoxDecoration(
                                    color: SupportColors.statusColor(s),
        ...
        body: wide
            ? Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(width: 1, color: SupportColors.border),
                Expanded(
                    flex: 2,
                    child: Padding(
                        padding: const EdgeInsets.all(12),
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (ticket.isMerged)
          Container(
              ...
              padding: const EdgeInsets.all(10),
              decoration: BoxDecoration(
                  color: SupportColors.textSecondary.withValues(alpha: 0.08),
    ...
    return Container(
        ...
        child: Column(children: [
          Row(children: [
            CircleAvatar(
                radius: 18,
                backgroundColor: SupportColors.accent.withValues(alpha: 0.2),
            ...
            Expanded(
                child: Column(
                  ...
                  Text(ticket.customerType.label,
                      style: const TextStyle(
                          color: SupportColors.textSecondary, fontSize: 12))
                ])),
